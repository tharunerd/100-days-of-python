...
## 📘 Overview
On Day 21 of the 100 Days of Python Bootcamp, I enhanced my Snake Game by adding **persistent score tracking** using file handling. This version saves the highest score in a file and updates it automatically when a new record is set — making the game more competitive and realistic.
