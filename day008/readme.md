# Day 8: Caesar Cipher – 100 Days of Code (Python Bootcamp by Angela Yu)
...
The Caesar Cipher is a substitution cipher where each letter in the plaintext is shifted a certain number of places down or up the alphabet, which acts as an encryption method.
